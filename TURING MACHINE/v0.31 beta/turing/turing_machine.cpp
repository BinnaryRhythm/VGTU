...
void turing_machine::pause_resume()
{
	if (pause == false)pause = true;
	else pause = false;
}

void turing_machine::resuming()
{
	processing_logic();
}

void turing_machine::stop_procesing()
{
	stop_processes = true;
}
...
void turing_machine::search_rule_for_needed_symbols()
{
	...
	{
		if (stop_processes == true) break;
		if (pause == true) while (pause == true) {
			if (stop_processes == true) break;
		}
...
void turing_machine::sleep(int speed)
{
